      ...
      <div class="content-wrap" :class="{ visible: mounted }">
        ...
        <div class="sections-grid">
          ...
          <div class="card">
            ...
            <div class="docs-list">
              <a v-if="application.cv_path" :href="`/storage/${application.cv_path}`" target="_blank" class="doc-link">
                <svg viewBox="0 0 14 14" fill="none" width="14" height="14">
                  <rect x="2" y="1" width="10" height="12" rx="1" stroke="currentColor" stroke-width="1.2"/>
                  <path d="M4 5h6M4 7.5h6M4 10h4" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/>
                </svg>
                Curriculum Vitae
              </a>
              <a v-if="application.sample_path" :href="`/storage/${application.sample_path}`" target="_blank" class="doc-link">
                <svg viewBox="0 0 14 14" fill="none" width="14" height="14">
                  <rect x="2" y="1" width="10" height="12" rx="1" stroke="currentColor" stroke-width="1.2"/>
                  <path d="M4 5h6M4 7.5h6M4 10h4" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/>
                </svg>
              ...
              <a v-if="application.extra_path" :href="`/storage/${application.extra_path}`" target="_blank" class="doc-link">
                <svg viewBox="0 0 14 14" fill="none" width="14" height="14">
                  <rect x="2" y="1" width="10" height="12" rx="1" stroke="currentColor" stroke-width="1.2"/>
                  <path d="M4 5h6M4 7.5h6M4 10h4" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/>
                </svg>
              ...
              <p v-if="!application.cv_path && !application.sample_path && !application.extra_path" class="empty-text">No documents uploaded.</p>
            </div>
          </div>
...
.doc-link { display: flex; align-items: center; gap: 10px; padding: 11px 16px; border: 1px solid rgba(11,28,56,0.08); color: #3a4a62; text-decoration: none; font-size: 13px; font-family: 'DM Sans', sans-serif; transition: all 0.2s; }
.doc-link:hover { border-color: rgba(201,168,76,0.4); color: #c9a84c; background: rgba(201,168,76,0.03); }
